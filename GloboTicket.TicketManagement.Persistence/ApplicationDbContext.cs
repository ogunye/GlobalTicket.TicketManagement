    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                EventDate = DateTime.Now.AddMonths(9),
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                Price = 400,
                Artist = "Many",
                EventDate = DateTime.Now.AddMonths(10),
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                Price = 135,
                Artist = "Nick Sailor",
                EventDate = DateTime.Now.AddMonths(8),
        ...
        {
            foreach (var entry in ChangeTracker.Entries<AuditableEntitiy>())
            {
                switch (entry.State)
                {
